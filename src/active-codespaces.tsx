...
export default function Command() {
  ...
  if (!data) {
    return <MenuBarExtra icon={{ source: { light: "github.png", dark: "github@dark.png" } }} isLoading={true} />;
  }
  ...
  return (
    ...
    >
      <MenuBarExtra.Item title={activeCodespaces.length ? "Active" : "No active codespaces"} />
